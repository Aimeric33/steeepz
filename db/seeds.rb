...
Checklist.all.each do |checklist|
  Section.create!(title: 'First section', checklist: checklist)
  Section.create!(title: 'Second section', checklist: checklist)
end
puts '🚩 Sections created!'

puts '📌 Creating steps...'
Section.all.each do |section|
  Step.create!(title: 'First step', section: section, completed: true)
  Step.create!(title: 'Second step', section: section, completed: false)
end
puts '📌 Steps created!'
